...
// In addition to propagating normal updates,
// has a finalized update for when the user stops dragging.
Tangle.classes.TKAdjustableNumberWait = {

    initialize: function (element, options, tangle, variable) {
        this.element = element;
        this.tangle = tangle;
        this.variable = variable;
        this.finalize = tangle.finalize;
